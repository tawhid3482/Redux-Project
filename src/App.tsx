  ...
  return (
    < div className="h-screen w-full flex justify-center items-center">
      <div className="flex p-10 border border-purple-400 rounded-md bg-slate-100">
        <button onClick={() => dispatch(increment())} className="text-white text-xl bg-green-500 px-3 py-2 rounded-lg mr-5">increment</button>

        <button onClick={() => dispatch(incrementByValue(5))} className="text-white text-xl bg-green-500 px-3 py-2 rounded-lg ">incrementByValue</button>
